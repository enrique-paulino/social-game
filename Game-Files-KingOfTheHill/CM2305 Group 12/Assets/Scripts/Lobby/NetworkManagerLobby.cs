    ...
    public class NetworkManagerLobby : NetworkManager {
        ...
        public void StartGame() {
            if (SceneManager.GetActiveScene().path == menuScene) {
                ...
                ServerChangeScene("KingOfTheHill"); // Temporary. Change to some logic to choose a random mini game
            }
        }

        public override void ServerChangeScene(string newSceneName) {

            if (SceneManager.GetActiveScene().path == menuScene && newSceneName.StartsWith("KingOfTheHill")) {
